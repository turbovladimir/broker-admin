...
final class Version20240516122755 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_access (id INT NOT NULL, ip VARCHAR(20) NOT NULL, added_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, _limit INT NOT NULL, PRIMARY KEY(id))');
    }
